...
public class DistributorScheduleController implements Initializable {
	...
	public void showStations(javafx.event.ActionEvent event) throws IOException {
		ViewResponse response = distributorService
				.loadAttachmentsInSchedule(scheduleTable.getSelectionModel().getSelectedItem());
	...
	public void assignCashier() {
		ViewResponse response = distributorService.assignCashier(scheduleTable.getSelectionModel().getSelectedItem(),
