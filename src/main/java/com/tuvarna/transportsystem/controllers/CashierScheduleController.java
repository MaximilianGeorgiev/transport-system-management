...
import com.tuvarna.transportsystem.services.CashierService;
...
public class CashierScheduleController implements Initializable {
	...
	public void initialize(URL url, ResourceBundle resourceBundle) {
		...
		cashierScheduleTable.setItems(cashierService.getScheduleForCashier(DatabaseUtils.currentUser));

		logger.info("Configured table view and populated trips.");
	}

	private void loadDepartureLocations() {
		ObservableList<String> locations = cashierService.getDepLocationsForCashierBySelectedRow(
				DatabaseUtils.currentUser, cashierScheduleTable.getSelectionModel().getSelectedItem());
	...
	private void loadArrivalLocations() {
		ObservableList<String> locations = cashierService.getArrLocationsForCashierBySelectedRow(
				DatabaseUtils.currentUser, cashierScheduleTable.getSelectionModel().getSelectedItem());
	...
	public void sellTicket(javafx.event.ActionEvent event) throws IOException {
		ViewResponse response = cashierService.sellTicket(cashierScheduleTable.getSelectionModel().getSelectedItem(),
