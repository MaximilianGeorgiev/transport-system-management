...
public class CompanyScheduleController implements Initializable {
	...
	public void showAttachments(javafx.event.ActionEvent event) throws IOException {
		ViewResponse response = companyService.scheduleShowAttachments(companyScheduleTable.getSelectionModel().getSelectedItem());
	...
	public void cancelOnClick(javafx.event.ActionEvent event) throws IOException {
		ViewResponse response = companyService.cancelTrip(companyScheduleTable.getSelectionModel().getSelectedItem());
