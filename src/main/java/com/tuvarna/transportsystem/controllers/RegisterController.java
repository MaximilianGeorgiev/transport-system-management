...
public class RegisterController implements Initializable {
	...
	public void registerButton(javafx.event.ActionEvent event) throws IOException {
		ViewResponse response = userService.register(fullnameTextField.getText(), usernameTextField.getText(),
				passwordTextField.getText(), locationChoiceBox.getSelectionModel().getSelectedItem());
