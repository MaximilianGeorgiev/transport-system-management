...
public class UserPanelController implements Initializable {
	...
	private List<Trip> getMatchingTrips() throws ParseException {
		// questionable
		ViewResponse constraintCheck = ValidationUtils.validateUserPanelGetMatchingTrips(
		...
		if (!constraintCheck.isValid()) {
			informationLabel.setText(constraintCheck.getMessage());
			return null;
		}

		logger.info("Returning a list of trips that match the search criteria of the customer.");
		return customerService.getMatchingTrips(departureChoiceBox.getSelectionModel().getSelectedItem(),
				arrivalChoiceBox.getSelectionModel().getSelectedItem(), tripDatePicker.getEditor(),
				quantityChoiceBox.getSelectionModel().getSelectedItem(),
				timeChoiceBox.getSelectionModel().getSelectedItem());
	}
	...
	public void loadquantity() {
		...
		quantityList.addAll(number_01, number_02, number_03, number_04, number_05, number_06, number_07, number_08, number_09,
				number_10);
		quantityChoiceBox.getItems().addAll(quantityList);
	...
	public void loadTime() {
		...
		quantityList.addAll(time_01, time_02, time_03, time_04, time_05, time_06, time_07, time_08, time_09, time_10, time_11,
				time_12, time_13, time_14, time_15, time_16, time_17, time_18, time_19, time_20, time_21, time_22,
				time_23, time_24, time_25);

		timeChoiceBox.getItems().addAll(quantityList);
	}
	...
	public void buyTicket() throws ParseException {
		ViewResponse response = customerService.buyTicket(availableTripsTable.getSelectionModel().getSelectedItem(),
